...
$pattern:/\b[\w\.]+\b/,
keyword:["BY","ON","WITH","METADATA","DISSECT","DROP","ENRICH","EVAL","EXPLAIN","FROM","FULL JOIN","GROK","INFO","INLINESTATS","JOIN","KEEP","LEFT JOIN","LEFT","LIMIT","LOOKUP JOIN","LOOKUP","METRICS","MV_EXPAND","RENAME","RIGHT JOIN","RIGHT","ROW","SHOW INFO","SHOW","SORT","STATS","WHERE"],
